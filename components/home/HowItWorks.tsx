    ...
    <section id="how-it-works" className="relative bg-white">
      ...
      <div className="container">
        <div className="padding-x pt-12 md:pt-[90px] relative z-5 flex flex-col items-center text-white">
          ...
          <h2 className="mt-2 md:mt-4 sub-heading">How It Works</h2>

          <p className="text-base leading-6 mt-1 md:mt-3 text-center">
            Get your shipment booked and tracked in <br className="md:hidden" />
            four simple steps.
          </p>
        </div>

        <div className="padding-x pt-6 md:pt-10 pb-8 md:pb-12 relative z-5">
          <div className="p-4 md:p-6 lg:py-14.5 lg:px-[45px] grid gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 rounded-[24px] bg-white ">
